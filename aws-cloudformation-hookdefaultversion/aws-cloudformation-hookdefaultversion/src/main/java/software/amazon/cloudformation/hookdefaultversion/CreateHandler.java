...
public class CreateHandler extends BaseHandlerStd {
    ...
    public ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(resourceModel, callbackContext)
                .then(progress -> {
                    ...
                    return proxy.initiate("AWS-CloudFormation-HookDefaultVersion::Create", proxyClient, model, progress.getCallbackContext())
    ...
    private String createArn(ResourceHandlerRequest<ResourceModel> request) {
        ...
        if (!StringUtils.isNullOrEmpty(resourceModel.getTypeVersionArn())) {
            ...
            String arn = String.format("arn:%s:cloudformation:%s:%s:type/hook/%s",
