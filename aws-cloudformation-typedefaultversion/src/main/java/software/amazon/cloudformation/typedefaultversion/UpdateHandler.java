    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-CloudFormation-TypeDefaultVersion::Update::PreUpdateCheck", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-CloudFormation-TypeDefaultVersion::Update::first", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                    ...
                    proxy.initiate("AWS-CloudFormation-TypeDefaultVersion::Update::second", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
